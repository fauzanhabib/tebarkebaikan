				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Pilih Donasi Mu</h1>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 single-price">
							<div class="top-part">
							<img class="img-fluid" src="img/mukenafix.png" alt="">
							...
							<div class="bottom-part">
								...
								<a class="price-btn text-uppercase" href="#">Donasi Now</a>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 single-price">
							<div class="top-part">
				...
				<div class="container">
					...
					<div class="row justify-content-center">
						...
						<dl class="accordion">
							...
							<dd>
							Ayo bersama mempersiapkan diri dan org lain untuk berpakaian baik menghadap Tuhan yang Maha Baik
							</dd>
							<dt>
								<a href="">Misi</a>
							</dt>
							<dd>
							* Bersama berdonasi mencukupi kebutuhan mukena<br>
							* Bersinergi memberikan informasi terkait lokasi atau masyarakat yang membutuhkan mukena<br>
							* Menebar mukena hingga jauh
							</dd>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-md-8 pb-30 header-text">
							<h1>Latest posts from our Donation</h1>
							<p>
					...
					<div class="row">	
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="img/bunemi.jpeg" alt="">	
							</div>
